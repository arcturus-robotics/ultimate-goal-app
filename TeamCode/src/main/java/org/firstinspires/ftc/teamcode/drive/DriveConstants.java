...
public class DriveConstants {
    ...
    // WHICH ONE??
    // motor shaft
    public static double TICKS_PER_REV = 24;
    // output shaft
    //public static final double TICKS_PER_REV = 1440;
    public static double MAX_RPM = 100;
    ...
    public static double TRACK_WIDTH = 14.1220472; // in
     ...
     */
    public static double MAX_VELOCITY = 30.0;
    public static double MAX_ACCELERATION = 30.0;
    ...
    public static double MAX_ANGULAR_JERK = 0.0;
